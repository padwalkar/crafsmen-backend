            ...
            <div className="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
                <ul className="navbar-nav">
                    <li className="nav-item">
                        ...
                        <NavLink className={(navData) => { return (navData.isActive ? 'active nav-link' : 'nav-link') }} to="/dashboard">
                    ...
                    <li className="nav-item">
                        ...
                        <NavLink className={(navData) => (navData.isActive ? 'active nav-link' : 'nav-link')} to="/service-list">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li className="nav-item">
                        <NavLink className={(navData) => (navData.isActive ? 'active nav-link' : 'nav-link')} to="/contractor-list">
                            ...
                            <span className="nav-link-text ms-1">Contractors</span>
                        </NavLink>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                        <NavLink className={(navData) => { return (navData.isActive ? 'active nav-link' : 'nav-link') }} to="/service-price-list">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="fas fa-money-bill-alt  text-dark"></i>
                            </div>
                            <span className="nav-link-text ms-1">Service Price</span>
                        </NavLink>
                    </li>
                    ...
                    <li className="nav-item">
                        <NavLink className={(navData) => (navData.isActive ? 'active nav-link' : 'nav-link')} to="/service-type">
                            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
